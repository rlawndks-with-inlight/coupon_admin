...
import { ContentWrapper, Wrapper, themeObj } from "src/@core/layouts/components/app/style-component";
...
Policy.getLayout = page => <ShoppingMallLayout>{page}</ShoppingMallLayout>
