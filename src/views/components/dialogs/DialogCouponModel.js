    ...
    <Fragment>
      <Dialog open={open} onClose={handleClose} aria-labelledby='form-dialog-title'>
        <div style={{ padding: '24px', display: 'flex', flexDirection: 'column' }}>
          ...
          <DialogContent>
            <TextField sx={{ marginBottom: '12px' }} id='coupon-number' autoComplete='new-password' type='number' autoFocus fullWidth label={head?.label} />
          </DialogContent>
...
export default DialogCouponModel
